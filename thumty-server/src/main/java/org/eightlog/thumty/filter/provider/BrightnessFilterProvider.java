...
import org.eightlog.thumty.image.filter.Brightness;
 ...
 */
public class BrightnessFilterProvider implements PostProcessAsyncFilterProvider {

    private final static String NAME = "brightness";
    ...
    public AsyncFilter getFilter(Vertx vertx, List<String> params, JsonObject config) {
        return new ImageAsyncFilter(vertx, new Brightness(getAmount(params, config)));
    }
