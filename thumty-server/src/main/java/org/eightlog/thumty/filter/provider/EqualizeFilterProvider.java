...
import org.eightlog.thumty.image.filter.Equalize;
 ...
 */
public class EqualizeFilterProvider implements PostProcessAsyncFilterProvider {

    private final static String NAME = "equalize";
    ...
    public AsyncFilter getFilter(Vertx vertx, List<String> params, JsonObject config) {
        return new ImageAsyncFilter(vertx, new Equalize());
    }
}
