...
public class FeatureDetectionServiceVertxEBProxy implements FeatureDetectionService {
  ...
  public FeatureDetectionServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public FeatureDetectionServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
